...
> 本体系现已演化为基于 **Alpha Genome (M+V+L)** 核心序列的军工级量化研究平台。我们通过跨越美股（2015-2025）与 A 股（2021-2026）的长周期严苛实证，锁定了具备“慢基因”特性的跨市场获利底座。
...
### 2. 纯净波动率提取 (HAC 修正)
通过 Newey-West HAC 修正在特征提取阶段剥离自相关干扰，确保因子暴露的统计纯正。
