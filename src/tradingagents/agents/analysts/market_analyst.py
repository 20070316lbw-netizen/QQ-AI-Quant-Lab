...
- IMPORTANT: You also have access to `get_market_prediction` tool which delegates predictive inference to the dedicated Kronos local time-series baseline model. Whenever asked to predict future trends, leverage this tool rather than guessing purely via text reasoning.
